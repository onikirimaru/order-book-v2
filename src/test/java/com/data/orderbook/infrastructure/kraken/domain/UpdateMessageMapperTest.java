...
class UpdateMessageMapperTest {
    ...
    public void should() {
        ...
        assertThat(result).satisfies(r -> {
            assertThat(r.b()).isEqualTo(List.of(
                    new PriceLevel(new BigDecimal("64347.60000"), new BigDecimal("0.00000000"), Instant.ofEpochSecond(1727348278L, 841901000L)),
                    new PriceLevel(new BigDecimal("64340.80000"), new BigDecimal("0.64859742"), Instant.ofEpochSecond(1727348278L, 626592000))
                    )
            );
        });
    }
